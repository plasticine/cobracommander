...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Build.git_commit_datetime'
        db.add_column('build_build', 'git_commit_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Build.git_commit_datetime'
        db.delete_column('build_build', 'git_commit_datetime')
